...
class UserRepositoryImpl implements UserRepository {
    ...
    try {
      ...
      if (e.response != null) {
        ...
        if (statusCode == HttpStatus.forbidden) {
          ...
          return Failure(AuthUnauthorizedExeception());
        }
      }
  ...
  Future<Either<RepositoryException, List<UserModel>>> getEmployees(
    ...
    try {
      ...
      return Failure(
          RepositoryException(message: 'Erro ao buscar coloaboradores'));
    } on ArgumentError catch (e, s) {
      log('Erro ao converter coloboradores,(Invald josn)',
          error: e, stackTrace: s);
      return Failure(RepositoryException(
          message: 'Erro ao converter coloboradores,(Invald josn)'));
    }
  }
